...
\node[below=14pt of af7, anchor=north west, xshift=-4mm,
   ...
   {\textbf{All feature-extraction convolutions use kernel $(1, 3, 3)$ with padding $(0, 1, 1)$; the skip projection is $1\times1\times1$.} The temporal dimension $T$ is preserved through the block and is not mixed by convolution; the SE module pools globally over $(T, H, W)$.};
